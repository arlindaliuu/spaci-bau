    ...
    <div class="bg-slate-900 text-white pt-8">
        ...
        <div class="container mx-auto px-4">
            <div class="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
                <?php
                $social_media = get_field('social_media_group', 'option');
                $socialMediaExist = $social_media['website_instagram_link'] || $social_media['website_facebook_link'] || $social_media['website_youtube_link'];
                
                if ( $socialMediaExist ) : ?>
                    <div class="w-full mb-8 md:mb-0 order-4 md:order-1">
                        <h1 class="text-xl mb-4">Finde uns</h1>
                        <ul class="flex">
                            <?php if ($social_media['website_instagram_link']): ?>
                            ...
                            <?php endif; ?>
                            <?php if ($social_media['website_facebook_link']): ?>
                                <li class="footer-social__item w-10 h-10 mr-2 mb-2">
                            ...
                            <?php endif; ?>
                            <?php if ($social_media['website_youtube_link']): ?>
                                <li class="footer-social__item w-10 h-10 mr-2 mb-2">
        ...
        <div class="h-fit w-full bg-blue-700">
            <div class="container mx-auto mt-8 grid justify-center items-center gap-4 h-full p-4">
                <div class="flex gap-4 items-center justify-between">
                    <img class="justify-self-center lg:justify-self-end h-full object-contain" src="<?= $logo_url; ?>" alt="Logo" class="z-20 p-4" width="100" height="40" />
                    <p class="text-center"><?php echo date("Y"); ?> &copy; Alle Rechte vorbehalten Franci Bau.</p>
                </div>
               <div class="flex gap-4 items-center">
                    <p class="text-center contents text-gray-700 text-sm">
