...
<div class="grid lg:grid-cols-2 p-6 md:p-20 max-w-mdm m-auto">
    <div class="grid targetDiv animate-duration-[3000ms]">
        ...
        target="_blank" class="bg-blue-50 text-white self-center shadow-2xl text-center cursor-pointer duration-500 hover:bg-orange-100 m-auto px-3 whitespace-nowrap py-2 mt-5 rounded-full hover:text-blue-50 hover:px-7 inline-block">Schicken Sie mich zu UNIQUE Baulemente</a>
        </div>
