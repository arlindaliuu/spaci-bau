            ...
            <main id="main" class="site-main" role="main">
                <section class="error-404 not-found">
                    <header class="page-header">
                        <h1 class="page-title text-gray-500 text-xl text-center"><?php esc_html_e( 'Hoppla! Diese Seite kann nicht gefunden werden.', 'your-theme-textdomain' ); ?></h1>
                    </header><!-- .page-header -->
                    <div class="bg-gray-100 h-screen justify-center">
                        ...
                        <center class="mt-6">
                            <a href="<?php echo get_option ('home'); ?>" class="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md">Geh zurück </a>
                        </center>
                    </div>
                </section><!-- .error-404 -->
            </main><!-- #main -->
